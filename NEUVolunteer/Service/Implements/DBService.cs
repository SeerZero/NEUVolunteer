...
namespace NEUVolunteer.Service.Implements
{
    public class DBService : IDBService
    {
        ...
        public const string DbName = "NEUVolunteer.NEUVolunteer.db";
        ...
        public async Task<Manager> GetManagerAsync(int id) =>
            await Connection.Table<Manager>().FirstOrDefaultAsync(p => p.mid.Equals(id));

        public async Task<Volunteer> GetVolunteerAsync(int id) =>
            await Connection.Table<Volunteer>().FirstOrDefaultAsync(p => p.vid.Equals(id));
